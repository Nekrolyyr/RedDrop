...
public class MyCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String donorcode = sp.getString("DonorCode", null);

        // Initialize objects for UI elements
        TextView info = (TextView) findViewById(R.id.textDonorInfo);
        ImageView barcodeView = (ImageView) findViewById(R.id.barcodeView);
        Button donatedButton = (Button) findViewById(R.id.btn_donated);
        ...
        if (donorcode == null) { // DONOR ID NOT SET YET
            ...
            int bgColor = getResources().getColor(R.color.colorAccent);
